...
//   value: string;
//   key: string;
//   children: Array<{ title: string; value: string; key: string; children: null }>;
// }> = [
//   {
//     title: "Departments",
//     value: "departments",
...
const Addshift = () => {
  ...
  const onChange = (newValue: string[]) => {
    ...
    for (var i = 0; i < value.length; i++) {
      console.log(value[i], "valfufufui");

      let main_value = value[i].split("-");
      console.log(main_value, "cgyfyfyfy");
      console.log(value[i], "vancjfdsfdbjhbd");
    }
  ...
  const { values, touched, errors, handleChange, handleBlur, handleSubmit } = useFormik({
    ...
    onSubmit: (values, action) => {
      ...
      axios.post("http://10.0.20.133:8000/shifts", formValues, {
        headers: {
          "Content-Type": "application/json",
