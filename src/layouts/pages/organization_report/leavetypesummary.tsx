    ...
    try {
      const response = await axios.get("http://10.0.20.133:8000/mg_leave_type", {
        headers: {
          ...
          Authorization:
            "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJvX2lkIjoxLCJlbWFpbCI6Im9tQGdtYWlsLmNvbSIsImV4cCI6MTY5OTI0NzIxOX0.t681A0UMThfD-3cbs5CIuFSheN6DBljthJlK7t4MFjo",
        },
      });
